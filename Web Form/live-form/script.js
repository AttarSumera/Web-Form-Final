...
function toggleExperienceTable(showTable) {
    var experienceTable = document.getElementById("experience-table");
    experienceTable.style.display = showTable ? "block" : "none";
}

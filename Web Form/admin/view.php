    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item active">
                    <!-- Closing the opening anchor tag -->
...
<div class="modal fade" id="logoutModal" tabindex="-1" aria-labelledby="logoutModalLabel"
    ...
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <div class="container border shadow-sm" style="margin-top:25px; padding:25px; width:75%">
                    ...
                    <div class="form-body">
                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"   style="margin-top: 100px;">
                            ...
                            <td>
                                ...
                                if (!empty($imagePath)) {
                                    echo '<img src="' . $imagePath . '" alt="Image" width="200px" height="300px"   class="img-fluid float-right" style="float: right;" />';
                                } else {
                            ...
                            <div class="form-group"  style="margin-top: 100px;">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="trainingCourse" name="trainingCourse" disabled>
                                            ...
                                            <option <?php if ($row["training_course"] == "Full Stack Development(java/phython)")echo "selected"; ?>>Full Stack Development(java/python)
                                            </option>
                            ...
                            <div class="form-group mt-2">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" id="counsellors_name" name="counsellors_name" disabled required>
                                            <?php
                                            $counsellor_options = ["Miss.Nivedita Mam", "Miss.Archana Mam", "Miss.Unnati Mam", "Miss.Farina Mam", "Miss.Komal Mam", "Mr.Nishant Sir", "Mr.Prashant Sir", "Mr.Aayush Sir"];

                                            foreach ($counsellor_options as $option) {
                                                $selected = ($row["counsellor_name"] == $option) ? "selected" : "";
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="trainingFees" name="trainingFees"  value='<?php echo $row["training_fees"]; ?>'
                                            placeholder="Rs/-"disabled required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="firstName" name="firstName" value='<?php echo $row["first_name"]; ?>'disabled required>
                                </div>
                                <div class="col-md-4">
                                    <label for="middle_name">Middle Name:</label>
                                    <input type="text" class="form-control" id="middleName" name="middleName" value='<?php echo $row["middle_name"]; ?>'disabled  required>
                                </div>
                                <div class="col-md-4">
                                    <label for="last_name">Last Name:</label>
                                    <input type="text" class="form-control" id="lastName" name="lastName" value='<?php echo $row["last_name"]; ?>'disabled required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" id="age" name="age" value='<?php echo $row["age"]; ?>'disabled required>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="mobile" name="mobile" value='<?php echo $row['mobile']; ?>'disabled required>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    disabled required><?php echo $row["permanent_address"]; ?></textarea>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <label>
                                        ...
                                        onchange="copyAddress()"  disabled > Same as Permanent
                                        Address
                                    </label>
                                    <textarea class="form-control" id="correspondenceAddress"
                                        name="correspondenceAddress" disabled required><?php echo $row["correspondence_address"]; ?></textarea>
                                </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3 ">
                                        <select class="form-control" id="physicallyChallenged"
                                            name="physicallyChallenged"disabled required>
                                            <option  value="" selected>Select an option</option>
                                            <option <?php if ($row["physically_challenged"] == "Yes")echo "selected"; ?>  value="Yes">Yes</option>
                                            <option <?php if ($row["physically_challenged"] == "No")echo "selected"; ?> value="No">No</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control" name="ssc_instituteName"
                                                    id="ssc_instituteName"disabled>
                                                    <option <?php if ($row["ssc_institute_name"] == "SSC")echo "selected"; ?> value="SSC">SSC</option>
                                                </select>
                                            </td>
                                            <td><input type="text" class="form-control" id="place" name="ssc_place"
                                            value='<?php echo $row['ssc_place']; ?>'disabled    required></td>
                                            <td><input type="text" class="form-control" id="university"
                                                    name="ssc_university"value='<?php echo $row['ssc_university']; ?>'disabled required>
                                            </td>
                                            <td><input type="number" class="form-control" id="percentage"
                                                    name="ssc_percentage" step="0.01" min="0" max="100"value='<?php echo $row['ssc_percentage']; ?>'disabled required></td>
                                            <td><input type="number" class="form-control" id="yearOfPassing"
                                                    name="ssc_yearOfPassing"value='<?php echo $row['ssc_year_of_passing']; ?>'disabled required></td>

                                        </tr>
                                        <tr>
                                            <td>
                                                <select class="form-control" name="hsc_instituteName"
                                                    id="hsc_instituteName" disabled>
                                                    <option <?php if ($row["hsc_institute_name"] == "HSC")echo "selected"; ?> value="HSC">HSC</option>
                                                    <option <?php if ($row["hsc_institute_name"] == "Diploma")echo "selected"; ?> value="Diploma">Diploma</option>
                                                </select>
                                            </td>
                                            <td><input type="text" class="form-control" id="place" name="hsc_place"
                                            value='<?php echo $row['hsc_place']; ?>'disabled required></td>
                                            <td><input type="text" class="form-control" id="university"
                                                    name="hsc_university" value='<?php echo $row['hsc_university']; ?>'disabled required>
                                            </td>
                                            <td><input type="number" class="form-control" id="percentage"
                                                    name="hsc_percentage" step="0.01" min="0" max="100"value='<?php echo $row['hsc_percentage']; ?>'disabled required></td>
                                            <td><input type="number" class="form-control" id="yearOfPassing"
                                                    name="hsc_yearOfPassing" value='<?php echo $row['hsc_year_of_passing']; ?>'disabled required></td>

                                        </tr>
                                        <tr>
                                            <td>
                                            <input type="text" class="form-control" id="graduation_instituteName" name="graduation_instituteName"
                                                 placeholder="Enter Graduation Ex.B.Tech"  value='<?php echo $row["graduation_institute_name"]; ?>' disabled required>
                                            </td>
                                            <td><input type="text" class="form-control" id="place"
                                                    name="graduation_place" value='<?php echo $row['graduation_place']; ?>'disabled required>
                                            </td>
                                            <td><input type="text" class="form-control" id="university"
                                                    name="graduation_university" value='<?php echo $row['graduation_university']; ?>'disabled required></td>
                                            <td><input type="number" class="form-control" id="percentage"
                                                    name="graduation_percentage" step="0.01" min="0" max="100" value='<?php echo $row['graduation_percentage']; ?>'disabled required>
                                            </td>
                                            <td><input type="number" class="form-control" id="yearOfPassing"
                                                    name="graduation_yearOfPassing"  value='<?php echo $row['graduation_year_of_passing']; ?>'disabled required></td>

                                        </tr>
                                        <tr>
                                            <td>
                                            <input type="text" class="form-control" id="postgraduation_instituteName" name="postgraduation_instituteName"
                                                 placeholder="Enter Postgraduation Ex.MBA"  value='<?php echo $row["postgraduation_institute_name"]; ?>' disabled required></td>
                                                
                                            </td>
                                            <td><input type="text" class="form-control" id="place"
                                                    name="postgraduation_place" value='<?php echo $row['postgraduation_place']; ?>'disabled>
                                            </td>
                                            <td><input type="text" class="form-control" id="university"
                                                    name="postgraduation_university"value='<?php echo $row['postgraduation_university']; ?>'disabled></td>
                                            <td><input type="number" class="form-control" id="percentage"
                                                    name="postgraduation_percentage" step="0.01" min="0" max="100"value='<?php echo $row['postgraduation_percentage']; ?>'disabled></td>
                                            <td><input type="number" class="form-control" id="yearOfPassing"
                                                    name="postgraduation_yearOfPassing"value='<?php echo $row['postgraduation_year_of_passing']; ?>'disabled></td>
                            ...
                            <div class="res-table">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input type="text" class="form-control" name="achievement_text"
                                            value='<?php echo $row['achievement_text']; ?>'disabled  required></td>
                                            <td><input type="text" class="form-control" name="activity_text"value='<?php echo $row['activity_text']; ?>'disabled required>
                                            </td>
                                            <td><input type="text" class="form-control" name="hobbies_interests_text"
                                            value='<?php echo $row['hobbies_interests_text']; ?>'disabled   required></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_read"
                                                    name="english_read" value="English"  <?php if ($row["english_read"] == "English") echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_write"
                                                    name="english_write" value="English" <?php if ($row["english_write"] == "English") echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_speak"
                                                    name="english_speak" value="English"<?php if ($row["english_speak"] == "English") echo "checked"; ?> disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_read"
                                                    name="hindi_read" value="Hindi"<?php if ($row["hindi_read"] == "Hindi") echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_write"
                                                    name="hindi_write" value="Hindi"<?php if ($row["hindi_write"] == "Hindi") echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_speak"
                                                    name="hindi_speak" value="Hindi"<?php if ($row["hindi_speak"] == "Hindi") echo "checked"; ?> disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_read"
                                                    name="marathi_read" value="Marathi"<?php if ($row["marathi_read"] == "Marathi") echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_write"
                                                    name="marathi_write" value="Marathi"<?php if ($row["marathi_write"] == "Marathi") echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input " id="can_speak"
                                                    name="marathi_speak" value="Marathi"<?php if ($row["marathi_speak"] == "Marathi") echo "checked"; ?> disabled>
                            ...
                            <div class="">
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="familyName" name="first_ref_name"
                                        value='<?php echo $row['first_ref_name']; ?>'disabled   required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="familyRelation">Relation:</label>
                                        <input type="text" class="form-control" id="familyRelation"
                                            name="first_ref_relation" value='<?php echo $row['first_ref_relation']; ?>'disabled  required>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="familyPhone">Mobile No:</label>
                                            <input type="tel" class="form-control" id="familyPhone"
                                                name="first_ref_mobile" minlength="10" value='<?php echo $row['first_ref_mobile']; ?>'disabled  required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="">
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="email" class="form-control" id="familyEmail" name="first_ref_email"
                                        value='<?php echo $row['first_ref_email']; ?>'disabled    required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="familyAddress">Address:</label>
                                        <textarea class="form-control" id="familyAddress" name="first_ref_address"
                                        disabled    required><?php echo $row['first_ref_address']; ?></textarea>
                                    </div>
                            ...
                            <div class="">
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <label for="familyName">Name:</label>
                                        <input type="text" class="form-control" id="familyName" name="second_ref_name"
                                        value='<?php echo $row['second_ref_name']; ?>'disabled      required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="familyRelation">Relation:</label>
                                        <input type="text" class="form-control" id="familyRelation"
                                            name="second_ref_relation" value='<?php echo $row['second_ref_relation']; ?>'disabled required>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="familyPhone">Mobile No:</label>
                                            <input type="tel" class="form-control" id="familyPhone"
                                                name="second_ref_mobile" minlength="10" value='<?php echo $row['second_ref_mobile']; ?>'disabled required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="">
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <label for="familyEmail">Email:</label>
                                        <input type="email" class="form-control" id="familyEmail"
                                            name="second_ref_email" value='<?php echo $row['second_ref_email']; ?>'disabled required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="familyAddress">Address:</label>
                                        <textarea class="form-control" id="familyAddress" name="second_ref_address"
                                          disabled  required><?php echo $row['second_ref_address']; ?> </textarea>
                                    </div>
                            ...
                            <div class="container">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="experience" id="yes" value="yes"
                                      onchange="toggleTable()"<?php if ($row["experience"] == "yes") echo "checked"; ?> disabled>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="experience" id="no" value="no"
                                         onchange="toggleTable()"<?php if ($row["experience"] == "no") echo "checked"; ?> disabled>
                            ...
                            <div id="experienceTable"  >
                                ...
                                <table class="table  table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>1 </td>
                                            <td><input type="text" class="form-control" name="organization"value='<?php echo $row['organization']; ?>'disabled></td>
                                            <td><input type="text" class="form-control" name="designation"value='<?php echo $row['designation']; ?>'disabled></td>
                                            <td><input type="date" class="form-control" name="from_date"value='<?php echo $row['from_date']; ?>'disabled></td>
                                            <td><input type="date" class="form-control" name="to_date"value='<?php echo $row['	to_date']; ?>'disabled></td>
                                        </tr>

                                        <tr>
                                            <td>2 </td>
                                            <td><input type="text" class="form-control" name="organization1" value='<?php echo $row["organization1"]; ?>' disabled></td>
                                            <td><input type="text" class="form-control" name="designation1" value='<?php echo $row["designation1"]; ?>' disabled></td>
                                            <td><input type="date" class="form-control" name="from_date1" value='<?php echo $row["from_date1"]; ?>' disabled></td>
                                            <td><input type="date" class="form-control" name="to_date1" value='<?php echo $row["to_date1"]; ?>' disabled></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="form-check form-check-inline ml-4">
                                <label class="form-check-label"><input type="checkbox" class="form-check-input"
                                        name="pune" value="Pune" <?php if ($row["preferred_job_location_pune"] == "Pune") echo "checked"; ?> disabled> Pune</label>
                            </div>
                            <div class="form-check  form-check-inline-sm ml-4">
                                <label class="form-check-label"><input type="checkbox" class="form-check-input"
                                        name="mumbai" value="Mumbai" <?php if ($row["preferred_job_location_mumbai"] == "Mumbai") echo "checked"; ?> disabled> Mumbai</label>
                            </div>
                            <div class="form-check form-check-inline ml-4 mb-3">
                                <label class="form-check-label"><input type="checkbox" class="form-check-input"
                                        name="bangalore" value="Bangalore" <?php if ($row["preferred_job_location_bangalore"] == "Bangalore") echo "checked"; ?> disabled> Bangalore</label>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="courseName" name="courseName"value='<?php echo $row['course_name']; ?>'disabled required>
                                </div>
                                <div class="col-md-6">
                                    <label class="" for="courseFees">Course fees:</label>
                                    <input type="number" class="form-control" id="courseFees" name="courseFees"
                                        placeholder="Rs/-"value='<?php echo $row['course_fees']; ?>'disabled required>
                                </div>
                            </div>
                            ...
                            <div class="res-table form-group">
                                <table class="table table-bordered  ">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <select class="form-control" id="fee" name="fee"disabled required>
                                                    <!-- <option value="" selected>select</option> -->
                                                    <option value="Enrollment Fee" <?php if ($row["fee"] == "Enrollment Fee")echo "selected"; ?>>Enrollment Fee</option>
                                                    
                                                </select>
                                            </td>
                                            <td><input type="number" class="form-control" id="enrollmentFee"
                                                    name="amount" placeholder="Rs/-"value='<?php echo $row['amount']; ?>'disabled required></td>
                                            <td>
                                                <select class="form-control" id="Schedule" name="Schedule"disabled required>
                                                    <!-- <option value="" selected>select</option> -->
                                                    <option value="At the time of Enrollment"<?php if ($row["schedule"] == "At the time of Enrollment")echo "selected"; ?>>At the time of Enrollment
                                                    </option>
                                                    <option value=" During the Trainig only"<?php if ($row["schedule"] == "During the Trainig only")echo "selected"; ?>>During the Training only
                                                    </option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="leftFees" name="leftFees"
                                        placeholder="Rs/-"value='<?php echo $row['left_fees']; ?>'disabled required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-4">
                                    <div class="form-group form-inline">
                                        ...
                                        <select class="form-control mr-2" id="paymentMode" name="paymentMode"disabled required>
                                            <!-- <option value="" selected>Select an option</option> -->
                                            <option value="Online"<?php if ($row["payment_mode"] == "Online")echo "selected"; ?>>Online</option>
                                            <option value="Cash"<?php if ($row["payment_mode"] == "Cash")echo "selected"; ?>>Cash</option>
                                            <option value="Cheque"<?php if ($row["payment_mode"] == "Cheque")echo "selected"; ?>>Cheque</option>
                            ...
                            <div class="container mt-5">
                                ...
                                <div class="checkbox form-check">
                                    <label>
                                        <input type="radio" name="paymentType" value="One Time" id="oneTimeCheckbox" onchange="toggleTable()"
                                            <?php if ($row["payment_type"] == "One Time") echo "checked disabled";?> disabled>
                                        One Time (Fees to be paid within 8 days of registration)
                                    </label>

                                    <div class="form-check hidden" id="agreeContinueCheckbox">
                                        <input class="form-check-input" type="checkbox" value="checkbox" id="agreeCheckbox" disabled 
                                            <?php if ($row["payment_type"] == "One Time") echo "checked";?>>
                                        <label class="form-check-label fs-6" for="agreeCheckbox"> I confirm that I have read, understood, and agree to the above terms and conditions.</label>
                                    </div>



                                    <label><input type="radio" name="paymentType" value="EMI" id="emiCheckbox"
                                            onchange="togglePaymentTable(true)"<?php if ($row["payment_type"] == "EMI") echo "checked disabled"; ?> disabled> EMI(Fees to be paid in 3
                                ...
                                <div class="res-table " id="emi-table">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <select class="form-control" name="EMI_NO_1" id="EMI_NO_1" disabled>
                                                ...
                                                <td><input type="date" class="form-control" id="selectedDate"
                                                        name="EMI_NO_1_date"value="<?php echo ($row["emi_no_1_date"]) ? $row["emi_no_1_date"] : ''; ?>"disabled >
                                                    </td>
                                                <td>
                                                    <input type="number" class="form-control" id="Amount"
                                                        name="EMI_NO_1_Amount" placeholder="Rs/-" value='<?php echo $row["emi_no_1_amount"]; ?>'disabled>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <select class="form-control" name="EMI_NO_2" id="EMI_NO_2" disabled>
                                                ...
                                                <td><input type="date" class="form-control" id="dateSecondEmi"
                                                        name="EMI_NO_2_date"value="<?php echo ($row["emi_no_2_date"]) ? $row["emi_no_2_date"] : ''; ?>"disabled></td>
                                                <td>
                                                    <input type="number" class="form-control" id="Amount"
                                                        name="EMI_NO_2_Amount" placeholder="Rs/-"value='<?php echo $row["emi_no_2_amount"]; ?>'disabled>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <select class="form-control" name="EMI_NO_3" id="EMI_NO_3" disabled>
                                                ...
                                                <td><input type="date" class="form-control" id="dateThirdEmi"
                                                        name="EMI_NO_3_date"value="<?php echo ($row["emi_no_3_date"]) ? $row["emi_no_3_date"] : ''; ?>"disabled></td>
                                                <td>
                                                    <input type="number" class="form-control" id="Amount"
                                                        name="EMI_NO_3_Amount" placeholder="Rs/-"value='<?php echo $row["emi_no_3_amount"]; ?>'disabled>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="checkbox form-check">
                                        <div id="agreeContinueCheckbox1" class="form-check pb-3 hidden">
                                            <input class="form-check-input" type="checkbox" id="agreeCheckbox"  <?php if ($row["payment_type"] == "EMI") echo "checked";?> disabled>
                                        ...
                                        <label><input type="radio" id="loanCheckbox" name="paymentType" value="Loan" onchange="toggleTable()"
                                                <?php if ($row["payment_type"] == "Loan") echo "checked disabled"; ?> disabled > Loan (Documents to be
                                            Submitted within 8
                                            days of
                                            registration)</label>
                                </div>
                                ...
                                <footer>
                                    ...
                                    <div class="form-check py-2">
                                        <input class="form-check-input" type="checkbox" id="agree-checkbox" disabled required checked>
                                            ...
                                            <div class="row justify-content-start">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- <label for="image-input" class="image-upload-box">
                                                        ...
                                                        <span class="custom-file-upload" id="image-status">Upload
                                                            signature</span>
                                                        <input type="file" id="image-input" name="signature"
                                                            accept="image/*" required  disabled/>
                                                    </label> -->
                                                    ...
                                                    <td>
                                                        ...
                                                        // Check if $imagePath is not empty (assuming it's a valid image path)
                                                        if (!empty($imagePath)) {
                                                            echo '<img src="' . $imagePath . '" alt="Image" width="200px" />';
                                                        } else {
                                                            // Display a placeholder or error message if $imagePath is empty
                                                            echo 'Image not found';
                                                        }
                                                ...
                                                <div class="col-md-4 col-sm-12 " style="padding-left: 40px;">
                                                    ...
                                                    <input type="date" class="form-control" id="date_submission"
                                                        name="date_submission"value="<?php echo ($row["date_submission"]) ? $row["date_submission"] : ''; ?>" disabled required>
                                                </div>
                                    ...
                                    <p class=""><strong> Radiant IT Services Pvt. Ltd. </strong>takes great pride in its
                                     ...
                                     <div class="mt-4 text-center ">
                                        <!-- <button type="submit" class="btn btn-primary form-group">Submit Form</button>
                                        <button type="submit" class="btn btn-primary mr-2">Submit form</button>  -->
                                         <button type="button" class="btn btn-primary ml-2 form-group" id="download">Download
                                            pdf</button>
                                    </div> 
...
<script>
    ...
    function updatePhotoLabel() {
        ...
        if (input.files.length > 0) {
            label.textContent = input.files[0].name; // Display the selected file name
        } else {
            label.textContent = 'Upload Photo'; // Reset label text if no file is selected
        }
    }

    // Attach the updatePhotoLabel function to the onchange event of the file input
    document.getElementById('photo').addEventListener('change', updatePhotoLabel);
</script>
<script>

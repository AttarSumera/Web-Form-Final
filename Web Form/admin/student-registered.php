                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                echo "<tr>
                                                <td>{$row['id']}</td>
                                                <td>{$row['training_course']}</td>
                                                <td>{$row['counsellor_name']}</td>
                                                <td>{$row['first_name']}</td>
                                                <td>{$row['middle_name']}</td>
                                                <td>{$row['last_name']}</td>
                                                <td class='phone-width'>{$row['mobile']}</td>
                                                
                                                <td>
                                                    <a href='update_student.php?id={$row['id']}' class='btn btn-primary'>Update</a>
                                                </td>
                                                <td>
                                                    <a href='javascript:void(0);' onclick='confirmDelete({$row['id']})' class='btn btn-danger' name='delete'>Delete</a>
                                                </td>

                                                <td>
                                                    <a href='view.php?id={$row['id']}' class='btn btn-success' name='view'> View</a>
                                                </td>
